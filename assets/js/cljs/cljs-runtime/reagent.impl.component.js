...
if((i < len)){
var k = (ks[i]);
var G__23031 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__23032 = (i + (1));
m = G__23031;
i = G__23032;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__22926 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__22926);
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22928 = c;
var G__22928__$1 = (((G__22928 == null))?null:G__22928.prototype);
if((G__22928__$1 == null)){
return null;
} else {
return (G__22928__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22930 = c;
var G__22930__$1 = (((G__22930 == null))?null:G__22930.prototype);
if((G__22930__$1 == null)){
return null;
} else {
return (G__22930__$1["render"]);
}
})() == null)))));
});
...
var G__22938 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__22938) : reagent.impl.component.as_element.call(null,G__22938));
};
...
var _STAR_current_component_STAR__orig_val__22939 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22940 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22940;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22939;
}});
...
return ((function (G__22946,G__22946__$1){
...
var c = this;
var G__22952_23046 = (c["cljsRatom"]);
if((G__22952_23046 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22952_23046);
}
...
var renders_23048 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_23049 = cljs.core.first(cljs.core.vals(renders_23048));
if((cljs.core.count(renders_23048) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23048))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23049)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23049], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__22953 = name;
switch (G__22953) {
case "":
...
var G__22955 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__22955);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__22956 = fiber;
var G__22956__$1 = (((G__22956 == null))?null:(G__22956["type"]));
if((G__22956__$1 == null)){
return null;
} else {
return (G__22956__$1["displayName"]);
}
})();
var parent = (function (){var G__22957 = fiber;
if((G__22957 == null)){
return null;
} else {
return (G__22957["return"]);
}
})();
var path = (function (){var G__22958 = parent;
var G__22958__$1 = (((G__22958 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__22958) : reagent.impl.component.fiber_component_path.call(null,G__22958)));
if((G__22958__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22958__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4047__auto__ = (function (){var G__22965 = c;
if((G__22965 == null)){
return null;
} else {
return (G__22965["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__22971._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__22984 = c;
if((G__22984 == null)){
return null;
} else {
return (G__22984["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__22986 = c;
if((G__22986 == null)){
return null;
} else {
return G__22986._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__22992 = instance;
if((G__22992 == null)){
return null;
} else {
return (G__22992["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__22997 = instance;
if((G__22997 == null)){
return null;
} else {
return G__22997._currentElement;
}
}
})();
var name = (function (){var G__23002 = elem;
var G__23002__$1 = (((G__23002 == null))?null:(G__23002["type"]));
if((G__23002__$1 == null)){
return null;
} else {
return (G__23002__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__23004 = elem;
if((G__23004 == null)){
return null;
} else {
return (G__23004["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__23005._owner;
}
}
})();
var path = (function (){var G__23006 = owner;
var G__23006__$1 = (((G__23006 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__23006) : reagent.impl.component.component_path.call(null,G__23006)));
if((G__23006__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23006__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__23007 = c;
var G__23007__$1 = (((G__23007 == null))?null:G__23007.constructor);
if((G__23007__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__23007__$1);
}
}
})();
