...
var o14198 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14198["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14199 = temp__5455__auto____$1;
return (o14199["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12083__auto__ = f;
return (o__12083__auto__["toString"]).call(o__12083__auto__);
} else {
return "";
}
}catch (e14203){var _ = e14203;
return "";
}});
...
try{var o__12083__auto___14329 = t;
(o__12083__auto___14329["cljs$lang$ctorPrWriter"]).call(o__12083__auto___14329,t,writer);
}catch (e14204){var __14330 = e14204;
}
...
var char_code = (function (){var o__12083__auto__ = (new String(char$));
return (o__12083__auto__["charCodeAt"]).call(o__12083__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12083__auto__ = String;
return (o__12083__auto__["fromCharCode"]).call(o__12083__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14206 = num_code;
switch (G__14206) {
case (1):
return (185);
...
var o__12083__auto__ = String;
return (o__12083__auto__["fromCharCode"]).call(o__12083__auto__,superscript_code);
});
/**
...
}catch (e14208){var _e__12108__auto__ = e14208;
return false;
}})())){
...
var vec__14209 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14209,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14216 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14216["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14217 = temp__5455__auto____$1;
return (o14217["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___14361 = arguments.length;
var i__4642__auto___14362 = (0);
while(true){
if((i__4642__auto___14362 < len__4641__auto___14361)){
args__4647__auto__.push((arguments[i__4642__auto___14362]));

var G__14364 = (i__4642__auto___14362 + (1));
i__4642__auto___14362 = G__14364;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14220){
var vec__14221 = p__14220;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14221,(0),null);
...
var G__14367 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__14368 = cljs.core.butlast(remaining_tokens);
name_tokens = G__14367;
remaining_tokens = G__14368;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14218){
...
var vec__14226 = cljs.core.split_with((function (p1__14225_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__14225_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14226,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14226,(1),null);
...
var vec__14229 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14229,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14229,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__14388 = cljs.core.rest(remaining_tokens);
var G__14389 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__14388;
name_tokens = G__14389;
continue;
} else {
...
var vec__14236 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14236,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14236,(1),null);
var vec__14239 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14239,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14239,(1),null);
var vec__14242 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14242,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14242,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14242,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14242,(3),null);
...
var vec__14250 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14250,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14250,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14250,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14250,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14250,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14250,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__14253 = temp__5455__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14253,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14253,(1),null);
var vec__14256 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14256,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14256,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__14261 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__14261) : devtools.munging.parse_fn_info_deep.call(null,G__14261));
})()));
}
} else {
return fn_info;
...
var G__14409 = (arity + (1));
var G__14410 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14263){
var vec__14264 = p__14263;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14264,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14264,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__14277_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__14278_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___14434 = arguments.length;
var i__4642__auto___14435 = (0);
while(true){
if((i__4642__auto___14435 < len__4641__auto___14434)){
args__4647__auto__.push((arguments[i__4642__auto___14435]));

var G__14436 = (i__4642__auto___14435 + (1));
i__4642__auto___14435 = G__14436;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14281){
var vec__14282 = p__14281;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14282,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14279){
var G__14280 = cljs.core.first(seq14279);
var seq14279__$1 = cljs.core.next(seq14279);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14280,seq14279__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14294__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14294__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14294__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14294__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14295 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14295,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14295,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14295,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14295,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14295,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14295,(5),null);
...
var o__12083__auto__ = f;
return (o__12083__auto__["getBasis"]).call(o__12083__auto__);
});
/**
...
}catch (e14300){var _e__12108__auto__ = e14300;
...
var G__14452 = (obj[cljs.core.first(path)]);
var G__14453 = cljs.core.rest(path);
obj = G__14452;
path = G__14453;
continue;
} else {
...
return (function (accum,p__14310){
var vec__14311 = p__14310;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14311,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14311,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14316){
var vec__14317 = p__14316;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14317,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14317,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14317,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14322,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14322,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__14322,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14320_SHARP_){
return (obj[cljs.core.first(p1__14320_SHARP_)]);
});})(name,sorted_matches,vec__14322,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
