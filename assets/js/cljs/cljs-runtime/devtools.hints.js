...
var G__12186 = cljs.core.PersistentArrayMap.EMPTY;
var G__12187 = native_stack_trace;
var G__12188 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__12189 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__12186,G__12187,G__12188,G__12189) : cljs.stacktrace.parse_stacktrace.call(null,G__12186,G__12187,G__12188,G__12189));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12191__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12191__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12191__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e12190){var _e = e12190;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___12209 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___12209)){
var seen_errors_12210 = temp__5455__auto___12209;
if(cljs.core.truth_(seen_errors_12210.has(self))){
} else {
seen_errors_12210.add(self);

var temp__5457__auto___12211 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___12211)){
var sense_12212 = temp__5457__auto___12211;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12212)].join('');
} else {
}
}
} else {
