...
var o__12083__auto___15534 = (function (){var o__12083__auto__ = (function (){var o__12083__auto__ = Promise;
return (o__12083__auto__["resolve"]).call(o__12083__auto__);
})();
return (o__12083__auto__["then"]).call(o__12083__auto__,callback);
})();
(o__12083__auto___15534["catch"]).call(o__12083__auto___15534,devtools.async.rethrow_outside_promise);
...
var G__15514_15538 = Error;
var target__12102__auto___15539 = G__15514_15538;
if(cljs.core.truth_(target__12102__auto___15539)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["unable to locate object path ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(null)," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15514_15538)].join('')),"\n","target__12102__auto__"].join('')));
}

(target__12102__auto___15539["stackTraceLimit"] = Infinity);
