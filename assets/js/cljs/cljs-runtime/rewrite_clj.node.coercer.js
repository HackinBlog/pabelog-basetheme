...
var G__20868_20906 = rewrite_clj.node.protocols.coerce;
var G__20869_20907 = "object";
var G__20870_20908 = ((function (G__20868_20906,G__20869_20907){
return (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});})(G__20868_20906,G__20869_20907))
;
goog.object.set(G__20868_20906,G__20869_20907,G__20870_20908);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__20874_20910 = rewrite_clj.node.protocols.coerce;
var G__20875_20911 = "number";
var G__20876_20912 = ((function (G__20874_20910,G__20875_20911){
return (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});})(G__20874_20910,G__20875_20911))
;
goog.object.set(G__20874_20910,G__20875_20911,G__20876_20912);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__20877_20913 = rewrite_clj.node.protocols.coerce;
var G__20878_20914 = "string";
var G__20879_20915 = ((function (G__20877_20913,G__20878_20914){
return (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});})(G__20877_20913,G__20878_20914))
;
goog.object.set(G__20877_20913,G__20878_20914,G__20879_20915);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__20881 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__20881) : f.call(null,G__20881));
})(),sq);
});
...
var comma_20916 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_20917 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = ((function (comma_20916,space_20917){
return (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(((function (comma_20916,space_20917){
return (function (p__20884){
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_20917,rewrite_clj.node.protocols.coerce(v),comma_20916], null);
});})(comma_20916,space_20917))
