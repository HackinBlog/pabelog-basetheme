...
if((i < len)){
var k = (ks[i]);
var G__18415 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__18416 = (i + (1));
m = G__18415;
i = G__18416;
continue;
...
return module$node_modules$react$index.Children.toArray(G__18329);
})());
} else {
var v = temp__5459__auto__;
...
return (G__18331__$1["reagentRender"]);
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__18336 = c;
var G__18336__$1 = (((G__18336 == null))?null:G__18336.prototype);
if((G__18336__$1 == null)){
return null;
} else {
return (G__18336__$1["render"]);
}
})() == null)))));
});
...
var G__18345 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__18345) : day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.as_element.call(null,G__18345));
};
...
var _STAR_current_component_STAR__orig_val__18351 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__18352 = c;
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__18352;
...
((day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.debug.tracking)?day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.debug.track_console:console).error(cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Error rendering component",cljs.core.str.cljs$core$IFn$_invoke$arity$1(day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.comp_name())].join('')));
} else {
}
}
}
}finally {day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__18351;
}});
...
var G__18357 = key;
var G__18357__$1 = (((G__18357 instanceof cljs.core.Keyword))?G__18357.fqn:null);
switch (G__18357__$1) {
...
return ((function (G__18357,G__18357__$1){
...
var or__4047__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.util._STAR_always_update_STAR_;
if(or__4047__auto__){
...
var c = this;
var G__18365_18507 = (c["cljsRatom"]);
if((G__18365_18507 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.ratom.dispose_BANG_(G__18365_18507);
}
...
var renders_18511 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_18512 = cljs.core.first(cljs.core.vals(renders_18511));
if((cljs.core.count(renders_18511) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_18511))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_18512)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_18512], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__18374 = name;
switch (G__18374) {
case "":
...
var G__18376 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__18376);
});
...
var name = (function (){var G__18378 = fiber;
var G__18378__$1 = (((G__18378 == null))?null:(G__18378["type"]));
if((G__18378__$1 == null)){
return null;
} else {
return (G__18378__$1["displayName"]);
}
})();
var parent = (function (){var G__18381 = fiber;
if((G__18381 == null)){
return null;
} else {
return (G__18381["return"]);
}
})();
var path = (function (){var G__18383 = parent;
var G__18383__$1 = (((G__18383 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__18383) : day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.fiber_component_path.call(null,G__18383)));
if((G__18383__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__18383__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4047__auto__ = (function (){var G__18385 = c;
if((G__18385 == null)){
return null;
} else {
return (G__18385["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__18387._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__18389 = c;
if((G__18389 == null)){
return null;
} else {
return (G__18389["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__18394 = c;
if((G__18394 == null)){
return null;
} else {
return G__18394._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__18396 = instance;
if((G__18396 == null)){
return null;
} else {
return (G__18396["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__18397 = instance;
if((G__18397 == null)){
return null;
} else {
return G__18397._currentElement;
}
}
})();
var name = (function (){var G__18398 = elem;
var G__18398__$1 = (((G__18398 == null))?null:(G__18398["type"]));
if((G__18398__$1 == null)){
return null;
} else {
return (G__18398__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__18401 = elem;
if((G__18401 == null)){
return null;
} else {
return (G__18401["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__18402._owner;
}
}
})();
var path = (function (){var G__18403 = owner;
var G__18403__$1 = (((G__18403 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__18403) : day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.component_path.call(null,G__18403)));
if((G__18403__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__18403__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var n = (function (){var or__4047__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__18407 = c;
var G__18407__$1 = (((G__18407 == null))?null:G__18407.constructor);
if((G__18407__$1 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.util.fun_name(G__18407__$1);
}
}
})();
...
var temp__5459__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.cached_react_class(tag);
if((temp__5459__auto__ == null)){
