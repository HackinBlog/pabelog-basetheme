...
var G__21458 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__21458;
continue;
} else {
var G__21459 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__21459;
continue;
}
} else {
var G__21460 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__21460;
continue;
}
}
...
var G__21446 = zloc;
var G__21447 = (function (){var G__21448 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__21449 = zloc;
var G__21449__$1 = (((G__21449 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__21449) : rewrite_clj.zip.node.call(null,G__21449)));
if((G__21449__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__21449__$1) : zprint.zutil.edn_STAR_.call(null,G__21449__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__21448) : rewrite_clj.zip.root.call(null,G__21448));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__21446,G__21447) : rewrite_clj.zip.replace.call(null,G__21446,G__21447));
});
/**
...
var G__21465 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__21465;
continue;
}
break;
...
var G__21466 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__21467 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__21466;
out = G__21467;
continue;
} else {
...
var G__21470 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__21471 = cljs.core.next(new_loc);
var G__21472 = replaced_loc;
nloc = G__21470;
new_loc = G__21471;
last_loc = G__21472;
continue;
...
return zprint.rewrite.sort_val((function (){var G__21452 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__21452) : rewrite_clj.zip.down.call(null,G__21452));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__21453_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__21453_SHARP_) : rewrite_clj.zip.tag.call(null,p1__21453_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__21453_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__21453_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
