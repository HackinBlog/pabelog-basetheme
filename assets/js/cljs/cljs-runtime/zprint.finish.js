...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__21533_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21533_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__21533_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__21539){
var vec__21542 = p__21539;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21542,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21542,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__21547,s,color,element,idx){
var map__21549 = p__21547;
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21549__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21549__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21549__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__21566 = (function (){var or__4047__auto__ = color;
...
var fexpr__21565 = (function (){var G__21567 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
:(cljs.core.truth_((function (){var and__4036__auto__ = focus;
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__21567) : style_map.call(null,G__21567));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__21576){
var vec__21577 = p__21576;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21577,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21577,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21577,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__21580){
var vec__21581 = p__21580;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21581,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21581,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21581,(2),null);
...
if(doing_nil_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),(function (){var or__4047__auto__ = last_elide;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var G__21742 = cljs.core.next(ssv);
var G__21743 = (this_ssv == null);
var G__21744 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__21745 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__21742;
doing_nil_QMARK_ = G__21743;
last_elide = G__21744;
out = G__21745;
continue;
}
...
var vec__21591 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21591,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21591,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21591,(2),null);
...
var G__21772 = cljs.core.next(remaining_cvec);
var G__21773 = new_idx;
var G__21774 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__21772;
idx = G__21773;
out = G__21774;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__21605,cursor_vec){
var vec__21606 = p__21605;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21606,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21606,(1),null);
var focus_vec = vec__21606;
...
var vec__21609 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21609,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21609,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__21622){
var vec__21623 = p__21622;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21623,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21623,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__21629,existing_count){
var vec__21630 = p__21629;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21630,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21630,(1),null);
...
var cursor__$1 = (function (){var x__4138__auto__ = zprint.finish.floor((0),(len - (1)));
var y__4139__auto__ = cursor;
return ((x__4138__auto__ < y__4139__auto__) ? x__4138__auto__ : y__4139__auto__);
})();
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__21630,s,cursor){
return (function (p1__21626_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__21626_SHARP_))));
});})(s__$1,len,cursor__$1,vec__21630,s,cursor))
...
var vec__21675 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21675,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21675,(1),null);
var cvec_element = vec__21675;
if((cvec_element == null)){
var G__21784 = cljs.core.next(cvec_nl);
var G__21785 = (idx + (1));
var G__21786 = start;
var G__21787 = out;
cvec_nl = G__21784;
...
if(cljs.core.truth_((function (){var and__4036__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(1));
...
var G__21788 = cljs.core.next(cvec_nl);
var G__21789 = (idx + (1));
var G__21790 = idx;
var G__21791 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__21788;
idx = G__21789;
start = G__21790;
out = G__21791;
...
var G__21792 = cljs.core.next(cvec_nl);
var G__21793 = (idx + (1));
var G__21794 = (idx + (1));
var G__21795 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__21792;
idx = G__21793;
start = G__21794;
out = G__21795;
...
if(cljs.core.truth_((function (){var and__4036__auto__ = (n > (1));
if(and__4036__auto__){
var and__4036__auto____$1 = new cljs.core.Keyword(null,"b","b",1482224470).cljs$core$IFn$_invoke$arity$1(where);
...
var G__21797 = cljs.core.next(cvec_nl);
var G__21798 = (idx + (1));
var G__21799 = idx;
var G__21800 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__21797;
idx = G__21798;
start = G__21799;
out = G__21800;
...
var G__21802 = cljs.core.next(cvec_nl);
var G__21803 = (idx + (1));
var G__21804 = start;
var G__21805 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__21802;
idx = G__21803;
start = G__21804;
out = G__21805;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__21679_SHARP_,p2__21678_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__21678_SHARP_)){
return cljs.core.reduced(p1__21679_SHARP_);
} else {
return (p1__21679_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__21680,p__21681){
var vec__21682 = p__21680;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21682,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21682,(1),null);
var vec__21685 = p__21681;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21685,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21685,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__21697,cvec,focus_vec){
var map__21698 = p__21697;
var map__21698__$1 = (((((!((map__21698 == null))))?(((((map__21698.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21698.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21698):map__21698);
var options = map__21698__$1;
var map__21699 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21698__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21699__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21699__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21699__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if(cljs.core.truth_((function (){var or__4047__auto__ = lines;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = paths;
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__21698,map__21698__$1,options,map__21699,map__21699__$1,focus,lines,paths){
return (function (p1__21695_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__21695_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__21698,map__21698__$1,options,map__21699,map__21699__$1,focus,lines,paths))
,path_vecs);
