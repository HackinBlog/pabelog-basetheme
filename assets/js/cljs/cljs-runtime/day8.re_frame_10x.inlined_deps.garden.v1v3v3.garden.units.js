 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$convert(p__17409,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17410__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17410__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var temp__5457__auto__ = cljs.core.re_matches(day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.units.unit_re,s);
if(cljs.core.truth_(temp__5457__auto__)){
var vec__17412 = temp__5457__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17412,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17412,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17412,(2),null);
...
var map__17415 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17415__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17416 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17416__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var G__17419 = (m1 + m2);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__17419) : u.call(null,G__17419));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__17474__delegate = function (x,y,more){
...
while (G__17475__i < G__17475__a.length) {G__17475__a[G__17475__i] = arguments[G__17475__i + 2]; ++G__17475__i;}
  more = new cljs.core.IndexedSeq(G__17475__a,0,null);
} 
...
var G__17482 = null;
if (arguments.length > 2) {
var G__17483__i = 0, G__17483__a = new Array(arguments.length -  2);
while (G__17483__i < G__17483__a.length) {G__17483__a[G__17483__i] = arguments[G__17483__i + 2]; ++G__17483__i;}
G__17482 = new cljs.core.IndexedSeq(G__17483__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17482);
}
...
var G__17420 = (- x);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__17420) : u.call(null,G__17420));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_subtractor_$_u___2 = (function (x,y){
var map__17421 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17421__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17422 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17422__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var G__17425 = (m1 - m2);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__17425) : u.call(null,G__17425));
});
...
while (G__17487__i < G__17487__a.length) {G__17487__a[G__17487__i] = arguments[G__17487__i + 2]; ++G__17487__i;}
  more = new cljs.core.IndexedSeq(G__17487__a,0,null);
} 
...
while (G__17490__i < G__17490__a.length) {G__17490__a[G__17490__i] = arguments[G__17490__i + 2]; ++G__17490__i;}
G__17489 = new cljs.core.IndexedSeq(G__17490__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17489);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__17426 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17426__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17427 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17427__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var G__17430 = (m1 * m2);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__17430) : u.call(null,G__17430));
});
...
var more = null;
if (arguments.length > 2) {
var G__17498__i = 0, G__17498__a = new Array(arguments.length -  2);
while (G__17498__i < G__17498__a.length) {G__17498__a[G__17498__i] = arguments[G__17498__i + 2]; ++G__17498__i;}
  more = new cljs.core.IndexedSeq(G__17498__a,0,null);
} 
...
G__17500 = new cljs.core.IndexedSeq(G__17501__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17500);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__17431 = ((1) / x);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__17431) : u.call(null,G__17431));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_divider_$_ud__2 = (function (x,y){
var map__17432 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17432__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17433 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17433__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var G__17436 = (m1 / m2);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__17436) : u.call(null,G__17436));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__17525__delegate = function (x,y,more){
...
while (G__17528__i < G__17528__a.length) {G__17528__a[G__17528__i] = arguments[G__17528__i + 2]; ++G__17528__i;}
  more = new cljs.core.IndexedSeq(G__17528__a,0,null);
} 
return G__17525__delegate.call(this,x,y,more);};
G__17525.cljs$lang$maxFixedArity = 2;
G__17525.cljs$lang$applyTo = (function (arglist__17529){
...
var G__17532 = null;
if (arguments.length > 2) {
var G__17533__i = 0, G__17533__a = new Array(arguments.length -  2);
while (G__17533__i < G__17533__a.length) {G__17533__a[G__17533__i] = arguments[G__17533__i + 2]; ++G__17533__i;}
G__17532 = new cljs.core.IndexedSeq(G__17533__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17532);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
