...
var len__4641__auto___14725 = arguments.length;
var i__4642__auto___14726 = (0);
while(true){
if((i__4642__auto___14726 < len__4641__auto___14725)){
args__4647__auto__.push((arguments[i__4642__auto___14726]));

var G__14727 = (i__4642__auto___14726 + (1));
i__4642__auto___14726 = G__14727;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14630){
...
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14631,G__14632,seq14630__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14696_SHARP_){
return (!((cljs.core.meta(p1__14696_SHARP_) == null)));
})))){
...
var map__14701 = opts;
var map__14701__$1 = (((((!((map__14701 == null))))?(((((map__14701.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14701.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14701):map__14701);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14701__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14709){var _e__12108__auto__ = e14709;
return false;
}})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
}catch (e14711){var _e__12108__auto__ = e14711;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__14715 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__14716 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__14716;

try{var map__14720 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14720__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__14715;
}});
...
;
var temp__5455__auto___14771 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___14771)){
var managed_print_level_14772 = temp__5455__auto___14771;
var _STAR_print_level_STAR__orig_val__14723_14773 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14724_14774 = managed_print_level_14772;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14724_14774;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__14723_14773,_STAR_print_level_STAR__temp_val__14724_14774,managed_print_level_14772,temp__5455__auto___14771,writer,opts,job_fn){
return (function (p1__14722_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__14722_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__14723_14773,_STAR_print_level_STAR__temp_val__14724_14774,managed_print_level_14772,temp__5455__auto___14771,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14723_14773;
}} else {
job_fn();
}
