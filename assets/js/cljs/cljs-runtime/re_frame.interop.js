...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__23204 = cljs.core.instance_QMARK_;
var expr__23205 = reactive_val;
if(cljs.core.truth_((pred__23204.cljs$core$IFn$_invoke$arity$2 ? pred__23204.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23205) : pred__23204.call(null,reagent.ratom.RAtom,expr__23205)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23204.cljs$core$IFn$_invoke$arity$2 ? pred__23204.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23205) : pred__23204.call(null,reagent.ratom.RCursor,expr__23205)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23204.cljs$core$IFn$_invoke$arity$2 ? pred__23204.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23205) : pred__23204.call(null,reagent.ratom.Reaction,expr__23205)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23204.cljs$core$IFn$_invoke$arity$2 ? pred__23204.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23205) : pred__23204.call(null,reagent.ratom.Track,expr__23205)))){
return "tr";
} else {
return "other";
}
