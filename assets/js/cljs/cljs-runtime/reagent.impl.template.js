...
var G__23047 = o;
(G__23047[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23099__delegate = function (args){
...
while (G__23100__i < G__23100__a.length) {G__23100__a[G__23100__i] = arguments[G__23100__i + 0]; ++G__23100__i;}
  args = new cljs.core.IndexedSeq(G__23100__a,0,null);
} 
return G__23099__delegate.call(this,args);};
G__23099.cljs$lang$maxFixedArity = 0;
G__23099.cljs$lang$applyTo = (function (arglist__23101){
var args = cljs.core.seq(arglist__23101);
return G__23099__delegate(args);
});
...
var G__23051 = o;
(G__23051[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__23105__i < G__23105__a.length) {G__23105__a[G__23105__i] = arguments[G__23105__i + 0]; ++G__23105__i;}
  args = new cljs.core.IndexedSeq(G__23105__a,0,null);
} 
...
var args = cljs.core.seq(arglist__23106);
...
var G__23053 = props;
var G__23053__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23053,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23053);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23053__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__23054){
...
var props = map__23055__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23055__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__23055,map__23055__$1,props,class$){
return (function (c){
...
});})(map__23055,map__23055__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__23057){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23058__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__23058,map__23058__$1,on_write){
return (function (){
...
});})(node_value,map__23058,map__23058__$1,on_write))
);
} else {
...
var G__23065 = jsprops;
(G__23065["defaultValue"] = value);

(G__23065["onChange"] = ((function (G__23065,v,value,on_change){
return (function (p1__23064_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__23064_SHARP_);
});})(G__23065,v,value,on_change))
);
...
var vec__23073 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23073,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23073,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23073,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___23155 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___23155 == null)){
} else {
var key_23156 = temp__5461__auto___23155;
(jsprops["key"] = key_23156);
}
...
var temp__5461__auto___23157 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___23157 == null)){
} else {
var key_23158 = temp__5461__auto___23157;
reagent.impl.template.oset(jsprops,"key",key_23158);
}
...
var G__23078 = reagent.impl.template.__GT_NativeWrapper();
(G__23078["name"] = c);
...
var G__23079 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__23079) : reagent.impl.template.as_element.call(null,G__23079));
} else {
...
var len__4641__auto___23160 = arguments.length;
var i__4642__auto___23161 = (0);
while(true){
if((i__4642__auto___23161 < len__4641__auto___23160)){
args__4647__auto__.push((arguments[i__4642__auto___23161]));

var G__23162 = (i__4642__auto___23161 + (1));
i__4642__auto___23161 = G__23162;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23081){
...
break;
default:
var G__23166 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__23166;
continue;
...
var n__4518__auto___23167 = a.length;
var i_23168 = (0);
while(true){
if((i_23168 < n__4518__auto___23167)){
(a[i_23168] = reagent.impl.template.as_element((a[i_23168])));

var G__23169 = (i_23168 + (1));
i_23168 = G__23169;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___23170 = a.length;
var i_23171 = (0);
while(true){
if((i_23171 < n__4518__auto___23170)){
var val_23172 = (a[i_23171]);
if(((cljs.core.vector_QMARK_(val_23172)) && ((reagent.impl.template.key_from_vec(val_23172) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_23171] = reagent.impl.template.as_element(val_23172));

var G__23173 = (i_23171 + (1));
i_23171 = G__23173;
continue;
} else {
}
...
var ctx = ({});
var vec__23085 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23085,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23085,(1),null);
...
var G__23088 = (cljs.core.count(argv) - first_child);
switch (G__23088) {
case (0):
...
case (1):
var G__23089 = comp;
var G__23090 = jsprops;
var G__23091 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__23089,G__23090,G__23091);
