...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__21204,k,f){
var vec__21205 = p__21204;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21205,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21205,(1),null);
var loc = vec__21205;
...
if(cljs.core.not((function (){var and__4036__auto__ = ploc;
...
var G__21236 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__21236;
continue;
}
break;
...
var G__21238 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__21238;
continue;
} else {
return zloc__$1;
...
var G__21239 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__21239;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__21215){
var vec__21216 = p__21215;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21216,(0),null);
var map__21219 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21216,(1),null);
...
var path = map__21219__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21219__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__21216;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__21223){
var vec__21224 = p__21223;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21224,(0),null);
var map__21227 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21224,(1),null);
var map__21227__$1 = (((((!((map__21227 == null))))?(((((map__21227.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21227.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21227):map__21227);
var path = map__21227__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21227__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__21224;
if(cljs.core.seq(r)){
...
var vec__21230 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21230,(0),null);
var map__21233 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21230,(1),null);
...
var path = map__21233__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21233__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21233__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21233__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21233__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
