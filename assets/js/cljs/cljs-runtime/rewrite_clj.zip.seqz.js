...
var G__21285 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__21285__$1 = (((G__21285 == null))?null:cljs.core.iterate(((function (G__21285,n0,temp__5455__auto__){
return (function (loc){
...
});})(G__21285,n0,temp__5455__auto__))
,G__21285));
...
var parent = zloc;
while(true){
if(cljs.core.not((function (){var and__4036__auto__ = loc;
...
var G__21288 = rewrite_clj.zip.move.right(v);
var G__21289 = rewrite_clj.zip.move.up(v);
loc = G__21288;
parent = G__21289;
continue;
} else {
var G__21290 = rewrite_clj.zip.move.right(v0);
var G__21291 = parent;
loc = G__21290;
parent = G__21291;
continue;
...
var G__21292 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__21293 = rewrite_clj.zip.move.up(v);
loc = G__21292;
parent = G__21293;
continue;
} else {
var G__21294 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__21295 = parent;
loc = G__21294;
parent = G__21295;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__21286 = zloc;
var G__21286__$1 = (((G__21286 == null))?null:rewrite_clj.zip.move.down(G__21286));
var G__21286__$2 = (((G__21286__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__21286__$1,k));
if((G__21286__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__21286__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__21287 = rewrite_clj.zip.move.down(zloc);
var G__21287__$1 = (((G__21287 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__21287));
if((G__21287__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__21287__$1);
}
})(),k);
}
});
