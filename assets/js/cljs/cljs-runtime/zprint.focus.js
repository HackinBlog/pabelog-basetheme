...
var G__21513 = (cljs.core.truth_((function (){var and__4036__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,new cljs.core.Keyword(null,"left","left",-399115937));
...
var G__21514 = (function (){var and__4036__auto__ = (function (){var or__4047__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index_type,new cljs.core.Keyword(null,"left","left",-399115937));
if(or__4047__auto__){
...
var G__21515 = new_next_nonws_QMARK_;
index = G__21513;
skip_to_right_QMARK_ = G__21514;
next_nonws_QMARK_ = G__21515;
continue;
}
}
break;
...
var G__21520 = zprint.focus.next_ssv(ssv,index);
var G__21521 = (moves - (1));
index = G__21520;
moves = G__21521;
continue;
}
...
var G__21522 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__21523 = cljs.core.next(nwp);
idx = G__21522;
nwp = G__21523;
continue;
}
...
var end = (cljs.core.truth_((function (){var and__4036__auto__ = ssv_next;
if(cljs.core.truth_(and__4036__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(start__$1,(0));
} else {
return and__4036__auto__;
}
})())?(function (){var fexpr__21509 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.dec,(1));
return (fexpr__21509.cljs$core$IFn$_invoke$arity$1 ? fexpr__21509.cljs$core$IFn$_invoke$arity$1(ssv_next) : fexpr__21509.call(null,ssv_next));
