...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__23809_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23809_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23809_SHARP_) <= ending)));
}));
});
...
var G__23822 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__23822__$1 = (((G__23822 instanceof cljs.core.Keyword))?G__23822.fqn:null);
switch (G__23822__$1) {
...
var and__4036__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(sub,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("sub","traits","sub/traits",1778340671),new cljs.core.Keyword(null,"unchanged?","unchanged?",1212001763)], null));
if(cljs.core.truth_(and__4036__auto__)){
return ((cljs.core.not_any_QMARK_(((function (and__4036__auto__){
return (function (p1__23823_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__23823_SHARP_);
});})(and__4036__auto__))
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__23824_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__23824_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23825){
var vec__23826 = p__23825;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23826,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23826,(1),null);
...
var new_state = (function (){var G__23829 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,reaction_id,((function (G__23829,G__23829__$1,tags,reaction_id,state){
...
});})(G__23829,G__23829__$1,tags,reaction_id,state))
);
...
return (function (all_state,p__23830){
var vec__23831 = p__23830;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23831,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23831,(1),null);
