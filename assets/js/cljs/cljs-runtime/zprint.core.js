...
if((function (){var and__4036__auto__ = cljs.core.coll_QMARK_(z);
...
var or__4047__auto__ = zprint.core.rewrite_clj_zipper_QMARK_(z);
...
var vec__22499 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__22502 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22502,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22502,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22499,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22499,(1),null);
...
var input__$1 = (function (){var or__4047__auto__ = input;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return coll;
...
var fzprint_fn = cljs.core.partial.cljs$core$IFn$_invoke$arity$4(zprint.zprint.fzprint,options__$2,(cljs.core.truth_((function (){var and__4036__auto__ = new cljs.core.Keyword(null,"file?","file?",1755223728).cljs$core$IFn$_invoke$arity$1(options__$2);
...
})())?(function (){var or__4047__auto__ = new cljs.core.Keyword(null,"indent","indent",-148200125).cljs$core$IFn$_invoke$arity$1(options__$2);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return (0);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__22507){
var vec__22509 = p__22507;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22509,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22509,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22512,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22512,(1),null);
...
var rest_options = (cljs.core.truth_((function (){var and__4036__auto__ = width;
if(cljs.core.truth_(and__4036__auto__)){
...
var auto_width = (cljs.core.truth_((function (){var and__4036__auto__ = cljs.core.not(width);
if(and__4036__auto__){
...
var vec__22521 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22521,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22521,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22521,(2),null);
var vec__22524 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22524,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22524,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22524,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__22528){
var vec__22529 = p__22528;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22529,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22529,(1),null);
...
var len__4641__auto___22591 = arguments.length;
var i__4642__auto___22592 = (0);
while(true){
if((i__4642__auto___22592 < len__4641__auto___22591)){
args__4647__auto__.push((arguments[i__4642__auto___22592]));

var G__22594 = (i__4642__auto___22592 + (1));
i__4642__auto___22592 = G__22594;
continue;
} else {
}
break;
...
return zprint.core.czprint_str_internal.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4648__auto__);
});

zprint.core.czprint_str_internal.cljs$core$IFn$_invoke$arity$variadic = (function (internal_options,coll,rest){
var vec__22535 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22535,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22535,(1),null);
...
var G__22538 = zprint.core.parse_string_all_options(rest_options);
var G__22539 = zprint.core.czprint_str_internal;
var G__22540 = ":parse-string-all? call";
var G__22541 = (function (){var G__22542 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__22542) : zprint.zutil.edn_STAR_.call(null,G__22542));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__22538,G__22539,G__22540,G__22541) : zprint.core.process_multiple_forms.call(null,G__22538,G__22539,G__22540,G__22541));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__22543 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22543,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22543,(1),null);
...
var color_style = (cljs.core.truth_((function (){var or__4047__auto__ = accept_vec;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = focus_vec;
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq22532){
var G__22533 = cljs.core.first(seq22532);
var seq22532__$1 = cljs.core.next(seq22532);
var G__22534 = cljs.core.first(seq22532__$1);
var seq22532__$2 = cljs.core.next(seq22532__$1);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22533,G__22534,seq22532__$2);
});
...
var or__4047__auto__ = (function (){try{return null;
}catch (e22547){var e = e22547;
return null;
}})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return zprint.core.zprint_str.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4648__auto__);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq22548){
var G__22549 = cljs.core.first(seq22548);
var seq22548__$1 = cljs.core.next(seq22548);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22549,seq22548__$1);
});
...
var args__4647__auto__ = [];
var len__4641__auto___22609 = arguments.length;
var i__4642__auto___22610 = (0);
while(true){
if((i__4642__auto___22610 < len__4641__auto___22609)){
args__4647__auto__.push((arguments[i__4642__auto___22610]));

var G__22612 = (i__4642__auto___22610 + (1));
i__4642__auto___22610 = G__22612;
continue;
} else {
}
break;
...
var argseq__4648__auto__ = ((((1) < args__4647__auto__.length))?(new cljs.core.IndexedSeq(args__4647__auto__.slice((1)),(0),null)):null);
return zprint.core.czprint_str.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4648__auto__);
});
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq22550){
var G__22551 = cljs.core.first(seq22550);
var seq22550__$1 = cljs.core.next(seq22550);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22551,seq22550__$1);
});
...
var args__4647__auto__ = [];
var len__4641__auto___22615 = arguments.length;
var i__4642__auto___22616 = (0);
while(true){
if((i__4642__auto___22616 < len__4641__auto___22615)){
args__4647__auto__.push((arguments[i__4642__auto___22616]));

var G__22618 = (i__4642__auto___22616 + (1));
i__4642__auto___22616 = G__22618;
continue;
} else {
}
break;
...
var argseq__4648__auto__ = ((((1) < args__4647__auto__.length))?(new cljs.core.IndexedSeq(args__4647__auto__.slice((1)),(0),null)):null);
return zprint.core.zprint.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4648__auto__);
});
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq22552){
var G__22553 = cljs.core.first(seq22552);
var seq22552__$1 = cljs.core.next(seq22552);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22553,seq22552__$1);
});
...
var argseq__4648__auto__ = ((((1) < args__4647__auto__.length))?(new cljs.core.IndexedSeq(args__4647__auto__.slice((1)),(0),null)):null);
return zprint.core.czprint.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4648__auto__);
});
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq22554){
var G__22555 = cljs.core.first(seq22554);
var seq22554__$1 = cljs.core.next(seq22554);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22555,seq22554__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__22563,form){
var vec__22564 = p__22563;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22564,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22564,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22564,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22564,(3),null);
...
var vec__22567 = (cljs.core.truth_((function (){var and__4036__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4036__auto__)){
var and__4036__auto____$1 = (indent === (0));
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22567,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22567,(1),null);
...
var internal_options = (cljs.core.truth_((function (){var or__4047__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var drop_QMARK_ = (!(cljs.core.not((function (){var and__4036__auto__ = space_count;
if(cljs.core.truth_(and__4036__auto__)){
var and__4036__auto____$1 = (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"skip","skip",602715391),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(next_options__$1))));
if(and__4036__auto____$1){
var or__4047__auto__ = new cljs.core.Keyword(null,"interpose","interpose",576140629).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"parse","parse",-1162164619).cljs$core$IFn$_invoke$arity$1(decision_options));
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var output_str = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"off","off",606440789),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(decision_options))) || (((cljs.core.not((function (){var or__4047__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
if(cljs.core.truth_((function (){var and__4036__auto__ = new_options;
if(cljs.core.truth_(and__4036__auto__)){
return (!(local_QMARK_));
} else {
return and__4036__auto__;
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [((local_QMARK_)?zprint.config.merge_deep.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([next_options__$1,new_options], 0)):(cljs.core.truth_((function (){var or__4047__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return whitespace_form_QMARK_;
...
)),output_str,(function (){var or__4047__auto__ = space_count;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return (0);
...
var interpose_option = (function (){var or__4047__auto__ = new cljs.core.Keyword(null,"interpose","interpose",576140629).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"parse","parse",-1162164619).cljs$core$IFn$_invoke$arity$1(rest_options));
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var forms = (function (){var G__22572 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__22572) : zprint.zutil.edn_STAR_.call(null,G__22572));
})();
...
var key_str = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(key)),": "].join('');
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(zprint.zprint.blanks(indent)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(key_str),cljs.core.str.cljs$core$IFn$_invoke$arity$1(spec_shift_right)].join('');
} else {
return null;
}
});
