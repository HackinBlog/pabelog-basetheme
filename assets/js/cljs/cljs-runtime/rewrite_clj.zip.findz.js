...
var len__4641__auto___21249 = arguments.length;
var i__4642__auto___21250 = (0);
while(true){
if((i__4642__auto___21250 < len__4641__auto___21249)){
args__4647__auto__.push((arguments[i__4642__auto___21250]));

var G__21251 = (i__4642__auto___21250 + (1));
i__4642__auto___21250 = G__21251;
continue;
} else {
}
break;
...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__21188){
var vec__21189 = p__21188;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21189,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__21189,additional){
return (function (node){
var and__4036__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(node),t);
...
;})(vec__21189,additional))
} else {
return ((function (vec__21189,additional){
return (function (p1__21184_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__21184_SHARP_),t);
});
;})(vec__21189,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq21185){
var G__21186 = cljs.core.first(seq21185);
var seq21185__$1 = cljs.core.next(seq21185);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21186,seq21185__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__21192,p__21193){
var map__21194 = p__21192;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21194__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21194__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21194__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21194__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__21195 = p__21193;
var map__21195__$1 = (((((!((map__21195 == null))))?(((((map__21195.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21195.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21195):map__21195);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21195__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21195__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var and__4036__auto__ = (r >= row);
if(and__4036__auto__){
var and__4036__auto____$1 = (r <= end_row);
if(and__4036__auto____$1){
var and__4036__auto____$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(r,row))?(c >= col):true);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21208_SHARP_){
var and__4036__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__21208_SHARP_) : p_QMARK_.call(null,p1__21208_SHARP_));
if(cljs.core.truth_(and__4036__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__21208_SHARP_)),pos);
} else {
return and__4036__auto__;
}
...
var G__21213 = zloc;
var G__21213__$1 = (((G__21213 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__21213) : f.call(null,G__21213)));
if((G__21213__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__21213__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__21214_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__21214_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__21237_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__21237_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__21244_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__21244_SHARP_),v);
}));
